    ...
    <div className="page-stack">
      <section className="hero-panel compact">
        <div>
          ...
          <p className="page-copy">등록 접수, 상담 연락, 지역 검증, 관리자 운영을 위해 필요한 최소한의 정보만 수집합니다.</p>
        </div>
      </section>
      ...
      <section className="detail-grid-shell">
        <div className="detail-card">
          ...
          <p className="page-copy">이름, 이메일, 휴대폰 번호, 매물 주소, 가격, 사진, 접속 위치 검증 결과, 유입 정보가 포함될 수 있습니다.</p>
        </div>
        <div className="detail-card">
          <h2 className="section-title">이용 목적</h2>
          <p className="page-copy">매물 등록 처리, 관리자 검토, 공개 매물 제공, 접수 이력 관리, 서비스 운영 통계에 사용합니다.</p>
        </div>
        <div className="detail-card">

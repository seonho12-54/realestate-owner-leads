    ...
    return (
      <div className="page-stack">
        <section className="hero-panel compact hero-panel-slim">
          ...
          <h1 className="page-title page-title-medium">매물 관리 화면을 불러오는 중입니다</h1>
        </section>
      </div>
    );
  }
    ...
    return (
      <div className="page-stack">
        <section className="hero-panel compact hero-panel-slim">
          ...
          <h1 className="page-title page-title-medium">관리자 목록을 불러오지 못했습니다</h1>
      ...
      <section className="hero-panel compact hero-panel-slim">
        <div>
          ...
          <p className="page-copy compact-copy">
            {session.user?.name} 관리자 계정으로 로그인되어 있습니다. 접수 검토, 공개 전환, 메모 관리까지 이 화면에서 처리합니다.
          </p>
        </div>
